...
namespace PrestaSharp.Factories
{
    public class StockAvailableFactory : RestSharpFactory
    {
        ...
        public Entities.stock_available Add(Entities.stock_available stockAvailable)
        { 
            long? idAux = stockAvailable.id;
            stockAvailable.id = null;
            RestRequest request = this.RequestForAdd("stock_availables", stockAvailable);
            Entities.stock_available aux = this.Execute<Entities.stock_available>(request);
            stockAvailable.id = idAux;
