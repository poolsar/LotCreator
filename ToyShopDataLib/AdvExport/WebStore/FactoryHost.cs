...
namespace WebStoreLib
{
    ...
    {
        static string BaseUrl = "http://localhost/prestashop/api";
        static string Account = "YUENYGUIVV7LBB7TG717RWESGTJ56L79";
        ...
        public static language RusLang
        {
            get
            {
                if (_rusLang == null)
                {
                    ...
                    _rusLang = languages.First(l => l.language_code == "ru-ru");
                }
                return _rusLang;
            }
        }
